...
import kotlinx.android.synthetic.main.result3aneemath.*

class Result3aneemath : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.result3aneemath)
        ...
        textviewttm3anneemath.text=ttm.toString()
        ...
        mlahda3anneemath.text="الملاحظة=$mlahda"
        textView14.text= ("المعدل----->$alm3dl----->$najh").toString()
        m3ml3anneemath.text="مجموع المعاملات=$m3mlat"
        m3mlflmwad3anneemath.text="مجموع المعدلات مضروبة في معاملاتها=$m3amlatflmwad"
