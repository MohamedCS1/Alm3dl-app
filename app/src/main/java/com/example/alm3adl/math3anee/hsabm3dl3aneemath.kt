package com.example.alm3adl.math3anee
...
import kotlinx.android.synthetic.main.hsabm3dl2aneeflsafa.m_f_fl
import kotlinx.android.synthetic.main.hsabm3dl2aneeflsafa.m_fl
import kotlinx.android.synthetic.main.hsabm3dl2aneeflsafa.m_i_fl
import kotlinx.android.synthetic.main.hsabm3dl2aneeflsafa.m_t_fl
import kotlinx.android.synthetic.main.hsabm3dl3aneemath.*
import java.math.RoundingMode

class hsabm3dl3aneemath : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {

        super.onCreate(savedInstanceState)
        setContentView(R.layout.hsabm3dl3aneemath)
        val databack = getSharedPreferences("3anneemath", MODE_PRIVATE)
        ...
        checkBoxm3fattm3anneemath.isChecked=databack.getBoolean("ischeckttm",false)
        ...
        if(checkBoxm3fattm3anneemath.isChecked){
            ttm3anneemath.isEnabled=false
            ttm3anneemath.setText(R.string.viditext)
            ttm3anneemath.setTextColor(ContextCompat.getColor(this,R.color.transparnt))
        }else{
            ttm3anneemath.isEnabled=true
            ttm3anneemath.setText(R.string.amhiklch)
            ttm3anneemath.setHint(R.string.hint3chrin)
            ttm3anneemath.setTextColor(ContextCompat.getColor(this,R.color.black))
        }
        ...
        ttm3anneemath.setText(databack.getString("ttm3anneemath",""))
        ...
        ttm3anneemath.filters= arrayOf<InputFilter>(InputFilterMinMax(0.0F,20.0F))
        ...
        checkBoxm3fattm3anneemath.setOnClickListener {
            if(checkBoxm3fattm3anneemath.isChecked){
                ttm3anneemath.isEnabled=false
                ttm3anneemath.setText(R.string.viditext)
                ttm3anneemath.setTextColor(ContextCompat.getColor(this,R.color.transparnt))
        ...
        buttonAutom3amlat3aneemath.setOnClickListener {
            m_a.setText("3")
            m_f.setText("2")
            m_e.setText("2")
            m_i.setText("2")
        ...
        buttonvide3anneemath.setOnClickListener {
            m_t_a.setText("")
            m_f_a.setText("")
            m_i_a.setText("")
            m_a.setText("")
    ...
    override fun onBackPressed() {
        ...
        alertt.buYes.setOnClickListener {
            val pref = getSharedPreferences("3anneemath", MODE_PRIVATE)
            val edit = pref.edit()
            ...
            edit.putString("ttm3anneemath",ttm3anneemath.text.toString())
            if (checkBoxm3fatchkilia.isChecked) {
        ...
        alertt.buNo.setOnClickListener {
            val V=""
            val dataput = getSharedPreferences("3anneemath", MODE_PRIVATE)
            ...
            edit.putString("ttm3anneemath",V)
            if (checkBoxm3fatchkilia.isChecked){
                edit.putBoolean("ischeckt",false)
            }else{
                edit.putBoolean("ischeckt",false)
    ...
    fun hsabntija3aneemath(view: View) {
        try {
            ...
            var ttm:Float=ttm3anneemath.text.toString().toFloat()
...
val m3amlatflmwad=m3dlarab + m3dlfrance + m3dlenglish + m3dlislamia + m3dltj + m3dlmath + m3dlalom + m3dlfizik + m3dlsport + m3dltrbiatchkilia+m3dlamazighia+ m3dlflsafa+ttm
                ...
                val intent = Intent(this, Result3aneemath::class.java)
