...
import kotlinx.android.synthetic.main.hsabm3dl2aneelong.*
import java.lang.Exception
import java.math.RoundingMode


class hsabm3dl2aneelong : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.hsabm3dl2aneelong)
        val databack = getSharedPreferences("2anneelong", MODE_PRIVATE)
        ...
        checkBoxm3fattm2anneelong.isChecked=databack.getBoolean("ischeckttm",false)
        ...
        if(checkBoxm3fattm2anneelong.isChecked){
            ttm2anneelong.isEnabled=false
            ttm2anneelong.setText(R.string.viditext)
            ttm2anneelong.setTextColor(ContextCompat.getColor(this,R.color.transparnt))
        }else{
            ttm2anneelong.isEnabled=true
            ttm2anneelong.setText(R.string.amhiklch)
            ttm2anneelong.setHint(R.string.hint3chrin)
            ttm2anneelong.setTextColor(ContextCompat.getColor(this,R.color.black))
        }
        ...
        ttm2anneelong.setText(databack.getString("ttm2anneelong",""))
        ...
        ttm2anneelong.filters= arrayOf<InputFilter>(InputFilterMinMax(0.0F,20.0F))
        ...
        checkBoxm3fattm2anneelong.setOnClickListener {
            if(checkBoxm3fattm2anneelong.isChecked){
                ttm2anneelong.isEnabled=false
                ttm2anneelong.setText(R.string.viditext)
                ttm2anneelong.setTextColor(ContextCompat.getColor(this,R.color.transparnt))
        ...
        buttonAutom3amalat2anneelong.setOnClickListener {
            m_a.setText("4")
            m_f.setText("4")
            m_e.setText("4")
            m_i.setText("2")
        ...
        buttonvide2anneelong.setOnClickListener {
            m_t_a.setText("")
            m_f_a.setText("")
            m_i_a.setText("")
            m_a.setText("")
    ...
    override fun onBackPressed() {
        ...
        alertt.buYes.setOnClickListener {
            val pref = getSharedPreferences("2anneelong", MODE_PRIVATE)
            val edit = pref.edit()
            ...
            edit.putString("ttm2anneelong",ttm2anneelong.text.toString())
        ...
        alertt.buNo.setOnClickListener {
            val V=""
            val dataput = getSharedPreferences("2anneelong", MODE_PRIVATE)
            ...
            edit.putString("ttm2anneelong",V)
            if (checkBoxm3fatchkilia.isChecked){
                edit.putBoolean("ischeckt",false)
            }else{
                edit.putBoolean("ischeckt",false)
    ...
    fun hsabntija2anneelong(view: View) {
        try {
            ...
            var ttm:Float=ttm2anneelong.text.toString().toFloat()
            ...
            var alm3dl =
                (m3dlarab + m3dlfrance + m3dlenglish + m3dlislamia + m3dltj + m3dlmath + m3dlalong  + m3dlsport + m3dltrbiatchkilia + m3dlamazighia+ttm ) / (m_a.text.toString()
...
val  m3amlatflmwad=m3dlarab + m3dlfrance + m3dlenglish + m3dlislamia + m3dltj + m3dlmath + m3dlalong  + m3dlsport + m3dltrbiatchkilia + m3dlamazighia+ttm
            val intent = Intent(this, Resulet2aneelong::class.java)
