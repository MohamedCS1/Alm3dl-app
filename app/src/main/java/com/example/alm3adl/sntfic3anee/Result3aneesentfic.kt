...
import kotlinx.android.synthetic.main.result3aneesentfic.*

class Result3aneesentfic : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.result3aneesentfic)
        ...
        textviewttm3anneesentfic.text=ttm.toString()
        ...
        mlahda3anneesentfic.text="الملاحظة=$mlahda"
        textView14.text= ("المعدل----->$alm3dl----->$najh").toString()
        m3ml3anneesentfic.text="مجموع المعاملات=$m3mlat"
        m3mlflmwad3anneesentfic.text="مجموع المعدلات مضروبة في معاملاتها=$m3amlatflmwad"
