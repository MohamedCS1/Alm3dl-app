...
class hsabm3dl2aneeflsafa : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        setContentView(R.layout.hsabm3dl2aneeflsafa)
        super.onCreate(savedInstanceState)

        val databack = getSharedPreferences("2anneeflsafa", MODE_PRIVATE)
        ...
        checkBoxm3fattm2anneeflsafa.isChecked=databack.getBoolean("ischeckttm", false)
        ...
        if(checkBoxm3fattm2anneeflsafa.isChecked){
            ttm2anneeflsafa.isEnabled=false
            ttm2anneeflsafa.setText(R.string.viditext)
            ttm2anneeflsafa.setTextColor(ContextCompat.getColor(this, R.color.transparnt))
        }else{
            ttm2anneeflsafa.isEnabled=true
            ttm2anneeflsafa.setText(R.string.amhiklch)
            ttm2anneeflsafa.setHint(R.string.hint3chrin)
            ttm2anneeflsafa.setTextColor(ContextCompat.getColor(this, R.color.black))
        }
        ...
        ttm2anneeflsafa.setText(databack.getString("ttm2anneeflsafa", ""))
        ...
        ttm2anneeflsafa.filters= arrayOf<InputFilter>(InputFilterMinMax(0.0F, 20.0F))
        ...
        checkBoxm3fattm2anneeflsafa.setOnClickListener {
                if(checkBoxm3fattm2anneeflsafa.isChecked){
                ttm2anneeflsafa.isEnabled=false
                ttm2anneeflsafa.setText(R.string.viditext)
                ttm2anneeflsafa.setTextColor(ContextCompat.getColor(this, R.color.transparnt))
        ...
        buttonAutom3amlat2aneeflsafa.setOnClickListener {
            m_a.setText("5")
            m_f.setText("3")
            m_e.setText("3")
            m_i.setText("2")
        ...
        buttonvide2anneeflsafa.setOnClickListener {
            ttm2anneeflsafa.setText("")
            m_t_a.setText("")
            m_f_a.setText("")
            m_i_a.setText("")
            m_a.setText("")
    ...
    override fun onBackPressed() {
        ...
        alertt.buYes.setOnClickListener {
            val pref = getSharedPreferences("2anneeflsafa", MODE_PRIVATE)
            val edit = pref.edit()
            edit.putString("ttm2anneeflsafa", ttm2anneeflsafa.text.toString())
        ...
        alertt.buNo.setOnClickListener {
            val V=""
            val dataput = getSharedPreferences("2anneeflsafa", MODE_PRIVATE)
            ...
            edit.putString("ttm2anneeflsafa", V)
            edit.putString("2anneeflsafa", V)
            if (checkBoxm3fattm2anneeflsafa.isChecked){
             edit.putBoolean("ischeckttm", false)
            }else{
                edit.putBoolean("ischeckttm", false)
    ...
    fun hsabntija2aneeflsafa(view: View) {
        try {
            ...
            var ttm:Float=ttm2anneeflsafa.text.toString().toFloat()
            ...
            val m3amlat=m_a.text.toString().toFloat() + m_f.text.toString().toFloat() + m_e.text.toString()
           .toFloat() + m_i.text.toString().toFloat() + m_tj.text.toString()
           .toFloat() + m_m.text.toString().toFloat() + m_3.text.toString()
           .toFloat() + m_fi.text.toString().toFloat() + m_t.text.toString()
           .toFloat() + m_s.text.toString().toFloat()+m_amz.text.toString().toFloat()+m_fl.text.toString().toFloat()
            ...
            if (dd <=20 && m_t_a.text.toString().toFloat() <= 20 && m_f_a.text.toString().toFloat() <= 20 && m_i_a.text.toString().toFloat() <= 20 && m_f_f.text.toString().toFloat() <= 20 && m_i_f.text.toString().toFloat() <= 20 &&m_t_f.text.toString().toFloat()<=20 &&m_f_e.text.toString().toFloat() <= 20 && m_i_e.text.toString().toFloat() <= 20 &&m_t_e.text.toString().toFloat()<=20&& m_f_i.text.toString().toFloat() <= 20 && m_i_i.text.toString().toFloat() <= 20 &&m_t_i.text.toString().toFloat()<=20 &&m_f_tj.text.toString().toFloat() <= 20 && m_i_tj.text.toString().toFloat() <= 20 && m_t_tj.text.toString().toFloat()<=20&&m_f_m.text.toString().toFloat() <= 20 && m_i_m.text.toString().toFloat() <= 20 && m_t_m.text.toString().toFloat()<=20&&m_f_3.text.toString().toFloat() <= 20 && m_i_3.text.toString().toFloat() <= 20&& m_t_3.text.toString().toFloat()<=20 && m_f_fi.text.toString().toFloat() <= 20 && m_i_fi.text.toString().toFloat() <= 20 &&m_t_fi.text.toString().toFloat()<=20 && m_f_t.text.toString().toFloat() <= 20 && m_i_t.text.toString().toFloat() <= 20 &&m_t_t.text.toString().toFloat()<=20 && m_f_s.text.toString().toFloat() <= 20 && m_i_s.text.toString().toFloat() <= 20 &&m_t_s.text.toString().toFloat()<=20&& m_t_amz.text.toString().toFloat()<=20&&m_i_amz.text.toString().toFloat()<=20&&m_f_a.text.toString().toFloat()<=20&&m_t_fl.text.toString().toFloat()<=20&&m_f_fl.text.toString().toFloat()<=20&&m_i_fl.text.toString().toFloat()<=20
            ) {
                val intent = Intent(this, Resulet2aneeflsafa::class.java)
                ...
                intent.putExtra(
                    "m3dlfrance", france.toBigDecimal().setScale(
                        2,
                        RoundingMode.HALF_EVEN
                    ).toFloat()
                )
                intent.putExtra(
                    "m3dlislamia", islamia.toBigDecimal().setScale(
                        2,
                        RoundingMode.HALF_EVEN
                    ).toFloat()
                )
                intent.putExtra(
                    "m3dlenglish", english.toBigDecimal().setScale(
                        2,
                        RoundingMode.HALF_EVEN
                    ).toFloat()
                )
                ...
                intent.putExtra(
                    "m3dlfizik", fizik.toBigDecimal().setScale(
                        2,
                        RoundingMode.HALF_EVEN
                    ).toFloat()
                )
                intent.putExtra(
                    "m3dlsport", sport.toBigDecimal().setScale(
                        2,
                        RoundingMode.HALF_EVEN
                    ).toFloat()
                )
                ...
                intent.putExtra(
                    "m3dlflsafa", flsafa.toBigDecimal().setScale(
                        2,
                        RoundingMode.HALF_EVEN
                    ).toFloat()
                )
                intent.putExtra(
                    "m3amlat",
                    m3amlat.toBigDecimal().setScale(2, RoundingMode.HALF_EVEN).toFloat()
                )
                intent.putExtra(
                    "m3amlatflmwad", m3amlatflmwad.toBigDecimal().setScale(
                        2,
                        RoundingMode.HALF_EVEN
                    ).toFloat()
                )
