...
import kotlinx.android.synthetic.main.result3aneelong.*

class Result3aneelong : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.result3aneelong)
        ...
        textviewttm3anneelong.text=ttm.toString()
        ...
        mlahda3anneelong.text="الملاحظة=$mlahda"
        textView14.text= ("المعدل----->$alm3dl----->$najh").toString()
        m3ml3anneelong.text="مجموع المعاملات=$m3mlat"
        m3mlflmwad3anneelong.text="مجموع المعدلات مضروبة في معاملاتها=$m3amlatflmwad"
