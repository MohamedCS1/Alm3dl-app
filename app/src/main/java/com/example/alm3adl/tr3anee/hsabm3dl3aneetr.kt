...
import kotlinx.android.synthetic.main.hsabm3dl3aneetr.*
import kotlinx.android.synthetic.main.hsabm3dl3aneetr.m_f_fl
import kotlinx.android.synthetic.main.hsabm3dl3aneetr.m_fl
import kotlinx.android.synthetic.main.hsabm3dl3aneetr.m_i_fl
import kotlinx.android.synthetic.main.hsabm3dl3aneetr.m_t_fl
import java.lang.Exception
import java.math.RoundingMode

class hsabm3dl3aneetr : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.hsabm3dl3aneetr)
        val databack = getSharedPreferences("3anneetr", MODE_PRIVATE)
        ...
        checkBoxm3fattm3anneetr.isChecked=databack.getBoolean("ischeckttm",false)
        ...
        if(checkBoxm3fattm3anneetr.isChecked){
            ttm3anneetr.isEnabled=false
            ttm3anneetr.setText(R.string.viditext)
            ttm3anneetr.setTextColor(ContextCompat.getColor(this,R.color.transparnt))
        }else{
            ttm3anneetr.isEnabled=true
            ttm3anneetr.setText(R.string.amhiklch)
            ttm3anneetr.setHint(R.string.hint3chrin)
            ttm3anneetr.setTextColor(ContextCompat.getColor(this,R.color.black))
        }
        ...
        ttm3anneetr.setText(databack.getString("ttm3anneetr",""))
        ...
        ttm3anneetr.filters= arrayOf<InputFilter>(InputFilterMinMax(0.0F,20.0F))
        ...
        checkBoxm3fattm3anneetr.setOnClickListener {
            if(checkBoxm3fattm3anneetr.isChecked){
                ttm3anneetr.isEnabled=false
                ttm3anneetr.setText(R.string.viditext)
                ttm3anneetr.setTextColor(ContextCompat.getColor(this,R.color.transparnt))
        ...
        buttonAutom3amalat3aneetr.setOnClickListener {
            m_tch.setText("7")
            m_a.setText("3")
            m_f.setText("2")
            m_e.setText("2")
        ...
        buttonvide3aneetr.setOnClickListener {
            m_t_fl.setText("")
            m_f_fl.setText("")
            m_i_fl.setText("")
            m_fl.setText("")
    ...
    override fun onBackPressed() {
        ...
        alertt.buYes.setOnClickListener {
            val pref = getSharedPreferences("3anneetr", MODE_PRIVATE)
            val edit = pref.edit()
            ...
            edit.putString("ttm3anneetr",ttm3anneetr.text.toString())
            if (checkBoxm3faamz.isChecked){
        ...
        alertt.buNo.setOnClickListener {
            val V = ""
            val dataput = getSharedPreferences("3anneetr", MODE_PRIVATE)
    ...
    fun hsabntija3anneetr(view: View) {
        try {
            ...
            var ttm:Float=ttm3anneetr.text.toString().toFloat()
            ...
            val alm3dl =
                (m3dlarab + m3dlfrance+m3dlflsafa + m3dlenglish + m3dlislamia + m3dltj + m3dlmath + m3dlfizik + m3dlsport +m3dlamazighia+m3dltchnlojia+ttm) / (m_a.text.toString()
                     .toFloat() + m_f.text.toString().toFloat() + m_e.text.toString()
                    .toFloat() + m_i.text.toString().toFloat() + m_tj.text.toString()
                    .toFloat() + m_m.text.toString().toFloat()  + m_fi.text.toString().toFloat() + m_s.text.toString().toFloat()+m_amz.text.toString().toFloat()+m_tch.text.toString().toFloat()+m_fl.text.toString().toFloat())

            val m3amlat=m_a.text.toString()
                .toFloat() + m_f.text.toString().toFloat() + m_e.text.toString()
                .toFloat() + m_i.text.toString().toFloat() + m_tj.text.toString()
                .toFloat() + m_m.text.toString().toFloat()  + m_fi.text.toString().toFloat() + m_s.text.toString().toFloat()+m_amz.text.toString().toFloat()+m_tch.text.toString().toFloat()+m_fl.text.toString().toFloat()
          val  m3amlatflmwad=m3dlarab + m3dlfrance+m3dlflsafa + m3dlenglish + m3dlislamia + m3dltj + m3dlmath + m3dlfizik + m3dlsport +m3dlamazighia+m3dltchnlojia+ttm
            val dd = alm3dl.toBigDecimal().setScale(2, RoundingMode.HALF_EVEN).toFloat()

                val intent = Intent(this, Result3anneetr::class.java)
