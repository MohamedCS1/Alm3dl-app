...
import kotlinx.android.synthetic.main.resulet1anneeliterary.*
...
class Resulet1anneeliterary : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.resulet1anneeliterary)
        ...
        if (m3dlinformatic==0.0F){
            textView21.text = "معفى"
        }else{
            textView21.text=m3dlinformatic.toString()
        }
        ...
        mlahda1anneelit.text="الملاحظة=$mlahda"
        textView14.text= ("المعدل----->$alm3dl----->$najh").toString()
        m3ml1anneelit.text="مجموع المعاملات=$m3mlat"
        m3mlflmwad1anneelit.text="مجموع المعدلات مضروبة في معاملاتها=$m3amlatflmwad"
