package com.example.alm3adl.literary
...
import kotlinx.android.synthetic.main.hsabm3dl1anneeliterary.*
...
class hsabm3dl1anneeliterary : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.hsabm3dl1anneeliterary)
        val databack = getSharedPreferences("1anneeliterary", MODE_PRIVATE)
        ...
        checkBoxm3fattm1anneeliterary.isChecked=databack.getBoolean("ischeckttm",false)
        ...
        if(checkBoxm3fattm1anneeliterary.isChecked){
            ttm1anneeliterary.isEnabled=false
            ttm1anneeliterary.setText(R.string.viditext)
            ttm1anneeliterary.setTextColor(ContextCompat.getColor(this,R.color.transparnt))
        }else{
            ttm1anneeliterary.isEnabled=true
            ttm1anneeliterary.setText(R.string.amhiklch)
            ttm1anneeliterary.setHint(R.string.hint3chrin)
            ttm1anneeliterary.setTextColor(ContextCompat.getColor(this,R.color.black))
        }
        ...
        ttm1anneeliterary.setText(databack.getString("ttm1anneeliterary",""))
        ...
        ttm1anneeliterary.filters= arrayOf<InputFilter>(InputFilterMinMax(0.0F,20.0F))
        ...
        checkBoxm3fattm1anneeliterary.setOnClickListener {
            if(checkBoxm3fattm1anneeliterary.isChecked){
                ttm1anneeliterary.isEnabled=false
                ttm1anneeliterary.setText(R.string.viditext)
                ttm1anneeliterary.setTextColor(ContextCompat.getColor(this,R.color.transparnt))
        ...
        buttonAutom3amlat1aneeliterary.setOnClickListener {
            m_a.setText("5")
            m_f.setText("3")
            m_e.setText("3")
            m_i.setText("2")
        ...
        buttonvide1anneeliterary.setOnClickListener {
            m_t_a.setText("")
            m_f_a.setText("")
            m_i_a.setText("")
            m_a.setText("")
    ...
    override fun onBackPressed() {
        ...
        alertt.buYes.setOnClickListener {
            val pref = getSharedPreferences("1anneeliterary", MODE_PRIVATE)
            val edit = pref.edit()
            ...
            edit.putString("ttm1anneeliterary",ttm1anneeliterary.text.toString())
            if (checkBoxm3fatchkilia.isChecked) {
        ...
        alertt.buNo.setOnClickListener {
            val V=""
            val dataput = getSharedPreferences("1anneeliterary", MODE_PRIVATE)
            ...
            edit.putString("ttm1anneeliterary",V)
            if (checkBoxm3fatchkilia.isChecked){
                edit.putBoolean("ischeckt",false)
            }else{
                edit.putBoolean("ischeckt",false)
    ...
    fun hsabntija1(view:View) {
        ...
        try {
            ...
            var alom: Float = (m_t_3.text.toString().toFloat() + m_f_3.text.toString()
                .toFloat() + (m_i_3.text.toString().toFloat() * 2)) / 4
            var m3dlalom: Float = alom * m_3.text.toString().toFloat()

            var fizik: Float =
                (m_t_fi.text.toString().toFloat() + m_f_fi.text.toString()
                    .toFloat() + (m_i_fi.text.toString().toFloat() * 2)) / 4
            var m3dlfizik: Float = fizik * m_fi.text.toString().toFloat()
            ...
            var amazighia: Float = (m_t_amz.text.toString().toFloat() + m_f_amz.text.toString().toFloat() + (m_i_amz.text.toString().toFloat() * 2)) / 4
            var m3dlamazighia: Float = amazighia * m_amz.text.toString().toFloat()

            var informatic: Float = (m_t_info.text.toString().toFloat() + m_f_info.text.toString().toFloat() + (m_i_info.text.toString().toFloat() * 2)) / 4
            var m3dlinformatic: Float = informatic * m_info.text.toString().toFloat()

            var ttm:Float=ttm1anneeliterary.text.toString().toFloat()
            ...
            var alm3dl =
                (m3dlarab + m3dlfrance + m3dlenglish + m3dlislamia + m3dltj + m3dlmath + m3dlalom + m3dlfizik + m3dlsport + m3dltrbiatchkilia+m3dlamazighia+m3dlinformatic+ttm) / (m_a.text.toString()
                    ...
                    .toFloat() + m_s.text.toString().toFloat()+m_amz.text.toString().toFloat()+m_info.text.toString().toFloat())
...
val m3amlat=m_a.text.toString()
    ...
    .toFloat() + m_fi.text.toString().toFloat() + m_t.text.toString()
    .toFloat() + m_s.text.toString().toFloat()+m_amz.text.toString().toFloat()+m_info.text.toString().toFloat()
            val m3amlatflmwad=m3dlarab + m3dlfrance + m3dlenglish + m3dlislamia + m3dltj + m3dlmath + m3dlalom + m3dlfizik + m3dlsport + m3dltrbiatchkilia+m3dlamazighia+m3dlinformatic+ttm
                val intent = Intent(this, Resulet1anneeliterary::class.java)
