package com.example.alm3adl.Gestion3anee
...
import kotlinx.android.synthetic.main.hsabm3dl3aneegestion.*
import kotlinx.android.synthetic.main.hsabm3dl3aneegestion.m_f_fl
import kotlinx.android.synthetic.main.hsabm3dl3aneegestion.m_fl
import kotlinx.android.synthetic.main.hsabm3dl3aneegestion.m_i_fl
import kotlinx.android.synthetic.main.hsabm3dl3aneegestion.m_t_fl
import java.math.RoundingMode

class hsabm3dl3aneegestion : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.hsabm3dl3aneegestion)
        val databack = getSharedPreferences("3anneegestion", MODE_PRIVATE)
        ...
        checkBoxm3fattm3anneegestion.isChecked=databack.getBoolean("ischeckttm",false)
        ...
        if(checkBoxm3fattm3anneegestion.isChecked){
            ttm3anneegestion.isEnabled=false
            ttm3anneegestion.setText(R.string.viditext)
            ttm3anneegestion.setTextColor(ContextCompat.getColor(this,R.color.transparnt))
        }else{
            ttm3anneegestion.isEnabled=true
            ttm3anneegestion.setText(R.string.amhiklch)
            ttm3anneegestion.setHint(R.string.hint3chrin)
            ttm3anneegestion.setTextColor(ContextCompat.getColor(this,R.color.black))
        }

        ttm3anneegestion.setText(databack.getString("ttm3anneegestion",""))
        ...
        ttm3anneegestion.filters= arrayOf<InputFilter>(InputFilterMinMax(0.0F,20.0F))
        ...
        checkBoxm3fattm3anneegestion.setOnClickListener {
            if(checkBoxm3fattm3anneegestion.isChecked){
                ttm3anneegestion.isEnabled=false
                ttm3anneegestion.setText(R.string.viditext)
                ttm3anneegestion.setTextColor(ContextCompat.getColor(this,R.color.transparnt))
        ...
        buttonAutom3amalat3anneegestion.setOnClickListener {
            m_a.setText("3")
            m_f.setText("2")
            m_e.setText("2")
            m_i.setText("2")
        ...
        buttonvide3anneegestion.setOnClickListener {
            m_t_f.setText("")
            m_f_f.setText("")
            m_i_f.setText("")
            m_f.setText("")
    ...
    override fun onBackPressed() {
        ...
        alertt.buYes.setOnClickListener {
            val pref = getSharedPreferences("3anneegestion", MODE_PRIVATE)
            val edit = pref.edit()
            ...
            edit.putString("ttm3anneegestion",ttm3anneegestion.text.toString())
            if (checkBoxm3fatchkilia.isChecked) {
        ...
        alertt.buNo.setOnClickListener {
            val V=""
            val dataput = getSharedPreferences("3anneegestion", MODE_PRIVATE)
            ...
            edit.putString("ttm3anneegestion",V)
            if (checkBoxm3fatchkilia.isChecked){
                edit.putBoolean("ischeckt",false)
            }else{
                edit.putBoolean("ischeckt",false)
    ...
    fun hsabntija3aneegestion(view: View) {
        try {
            ...
            var flsafa = (m_t_fl.text.toString().toFloat() + m_f_fl.text.toString()
                .toFloat() + (m_i_fl.text.toString().toFloat() * 2)) / 4
            var m3dlflsafa = flsafa * m_fl.text.toString().toFloat()

            var ttm:Float=ttm3anneegestion.text.toString().toFloat()
            ...
            var alm3dl =
                (m3dlarab + m3dlfrance + m3dlenglish + m3dlislamia + m3dltj + m3dlmath + m3dlsys + m3dlgestion + m3dlsport + m3dltrbiatchkilia + m3dlamazighia + m3dlcompta +m3dlflsafa+ttm) / (m_a.text.toString()
                    ...
                    .toFloat() + m_ges.text.toString().toFloat() + m_t.text.toString().toFloat()+ m_f.text.toString().toFloat())
val m3amlat=m_a.text.toString().toFloat() + m_f.text.toString().toFloat() + m_e.text.toString()
    ...
    .toFloat() + m_ges.text.toString().toFloat() + m_t.text.toString().toFloat()+ m_f.text.toString().toFloat()
            ...
            val m3amlatflmwad=m3dlarab + m3dlfrance + m3dlenglish + m3dlislamia + m3dltj + m3dlmath + m3dlsys + m3dlgestion + m3dlsport + m3dltrbiatchkilia + m3dlamazighia + m3dlcompta +m3dlflsafa+ttm
            val dd = alm3dl.toBigDecimal().setScale(2, RoundingMode.HALF_EVEN).toFloat()


                val intent = Intent(this, Result3aneegestion::class.java)
