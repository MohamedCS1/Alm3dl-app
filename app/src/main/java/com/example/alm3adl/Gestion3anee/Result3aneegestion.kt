...
import kotlinx.android.synthetic.main.resulet2aneegestion.textView3
import kotlinx.android.synthetic.main.result3aneegestion.*
import kotlinx.android.synthetic.main.result3aneegestion.textView91

class Result3aneegestion : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.result3aneegestion)
        ...
        textviewttm3anneegestion.text=ttm.toString()
        textView91.text=m3dlflsafa.toString()
        ...
        mlahda3anneeges.text="الملاحظة=$mlahda"
        textView14.text= ("المعدل----->$alm3dl----->$najh").toString()
        m3ml3anneeges.text="مجموع المعاملات=$m3mlat"
        m3mlflmwad3anneeges.text="مجموع المعدلات مضروبة في معاملاتها=$m3amlatflmwad"
