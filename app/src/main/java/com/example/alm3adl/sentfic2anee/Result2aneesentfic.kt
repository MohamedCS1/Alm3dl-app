...
import kotlinx.android.synthetic.main.result2aneesentfic.*

class Result2aneesentfic : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.result2aneesentfic)
        ...
        textviewttm2anneesentfic.text=ttm.toString()
        ...
        mlahda2anneesentfic.text="الملاحظة=$mlahda"
        textView14.text= ("المعدل----->$alm3dl----->$najh").toString()
        m3ml2anneesentfic.text="مجموع المعاملات=$m3mlat"
        m3mlflmwad2anneesentfic.text="مجموع المعدلات مضروبة في معاملاتها=$m3amlatflmwad"
