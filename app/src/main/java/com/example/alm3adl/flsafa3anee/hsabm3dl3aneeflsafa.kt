...
import kotlinx.android.synthetic.main.hsabm3dl3aneeflsafa.*
...
class hsabm3dl3aneeflsafa : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {

        super.onCreate(savedInstanceState)
        setContentView(R.layout.hsabm3dl3aneeflsafa)
        val databack = getSharedPreferences("3anneeflsafa", MODE_PRIVATE)
        ...
        checkBoxm3fattm3anneeflsafa.isChecked=databack.getBoolean("ischeckttm",false)
        ...
        if(checkBoxm3fattm3anneeflsafa.isChecked){
            ttm3anneeflsafa.isEnabled=false
            ttm3anneeflsafa.setText(R.string.viditext)
            ttm3anneeflsafa.setTextColor(ContextCompat.getColor(this,R.color.transparnt))
        }else{
            ttm3anneeflsafa.isEnabled=true
            ttm3anneeflsafa.setText(R.string.amhiklch)
            ttm3anneeflsafa.setHint(R.string.hint3chrin)
            ttm3anneeflsafa.setTextColor(ContextCompat.getColor(this,R.color.black))
        }
        ...
        ttm3anneeflsafa.setText(databack.getString("ttm3anneeflsafa",""))
        ...
        ttm3anneeflsafa.filters= arrayOf<InputFilter>(InputFilterMinMax(0.0F,20.0F))
        ...
        checkBoxm3fattm3anneeflsafa.setOnClickListener {
            if(checkBoxm3fattm3anneeflsafa.isChecked){
                ttm3anneeflsafa.isEnabled=false
                ttm3anneeflsafa.setText(R.string.viditext)
                ttm3anneeflsafa.setTextColor(ContextCompat.getColor(this,R.color.transparnt))
        ...
        buttonAutom3amalat3anneeflsafa.setOnClickListener {
            m_a.setText("6")
            m_f.setText("3")
            m_e.setText("3")
            m_i.setText("2")
        ...
        buttonvide3anneeflsafa.setOnClickListener {
            ttm3anneeflsafa.setText("")
            m_t_a.setText("")
            m_f_a.setText("")
            m_i_a.setText("")
            m_a.setText("")
    ...
    override fun onBackPressed() {
        ...
        alertt.buYes.setOnClickListener {
            ...
            val pref = getSharedPreferences("3anneeflsafa", MODE_PRIVATE)
            val edit = pref.edit()
            ...
            edit.putString("ttm3anneeflsafa",ttm3anneeflsafa.text.toString())
            if (checkBoxm3fatchkilia.isChecked) {
        ...
        alertt.buNo.setOnClickListener {
            val V=""
            val dataput = getSharedPreferences("3anneeflsafa", MODE_PRIVATE)
            ...
            edit.putString("ttm3anneeflsafa",V)
    ...
    fun hsabntija3anneeflsafa(view: View) {
        try {
            ...
            var ttm:Float=ttm3anneeflsafa.text.toString().toFloat()
            ...
            var alm3dl =
                (m3dlarab + m3dlfrance + m3dlenglish + m3dlislamia + m3dltj + m3dlmath + m3dlsport + m3dltrbiatchkilia + m3dlamazighia+m3dlflsafa+ttm ) / (m_a.text.toString()
                    .toFloat() + m_f.text.toString().toFloat() + m_e.text.toString()
                    .toFloat() + m_i.text.toString().toFloat() + m_tj.text.toString()
                    .toFloat() + m_m.text.toString().toFloat() + m_t.text.toString()
...
val m3amlat=m_a.text.toString()
    ...
    .toFloat() + m_s.text.toString().toFloat() + m_amz.text.toString()
    .toFloat() + m_fl.text.toString().toFloat()
val m3amlatflmwad=m3dlarab + m3dlfrance + m3dlenglish + m3dlislamia + m3dltj + m3dlmath + m3dlsport + m3dltrbiatchkilia + m3dlamazighia+m3dlflsafa+ttm
            val dd = alm3dl.toBigDecimal().setScale(2, RoundingMode.HALF_EVEN).toFloat()


                val intent = Intent(this, Result3aneeflsafa::class.java)
