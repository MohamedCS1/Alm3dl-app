...
import kotlinx.android.synthetic.main.resulet2aneemath.*

class Resulet2aneemath : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.resulet2aneemath)
        ...
        textviewttm2anneemath.text=ttm.toString()
        ...
        mlahda2anneemath.text="الملاحظة=$mlahda"
        textView14.text= ("المعدل----->$alm3dl----->$najh").toString()
        m3ml2anneemath.text="مجموع المعاملات=$m3mlat"
        m3mlflmwad2anneemath.text="مجموع المعدلات مضروبة في معاملاتها=$m3amlatflmwad"
