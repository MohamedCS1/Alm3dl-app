package com.example.alm3adl.math2anee
...
class hsabm3dl2anneemath : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.hsabm3dl2anneemath)
        val databack = getSharedPreferences("2anneemath", MODE_PRIVATE)
        ...
        checkBoxm3fattm2anneemath.isChecked=databack.getBoolean("ischeckttm",false)
        ...
        if(checkBoxm3fattm2anneemath.isChecked){
            ttm2anneemath.isEnabled=false
            ttm2anneemath.setText(R.string.viditext)
            ttm2anneemath.setTextColor(ContextCompat.getColor(this,R.color.transparnt))
        }else{
            ttm2anneemath.isEnabled=true
            ttm2anneemath.setText(R.string.amhiklch)
            ttm2anneemath.setHint(R.string.hint3chrin)
            ttm2anneemath.setTextColor(ContextCompat.getColor(this,R.color.black))
        }
        ...
        ttm2anneemath.setText(databack.getString("ttm2anneemath",""))
        ...
        ttm2anneemath.filters= arrayOf<InputFilter>(InputFilterMinMax(0.0F,20.0F))
        ...
        checkBoxm3fattm2anneemath.setOnClickListener {
            if(checkBoxm3fattm2anneemath.isChecked){
                ttm2anneemath.isEnabled=false
                ttm2anneemath.setText(R.string.viditext)
                ttm2anneemath.setTextColor(ContextCompat.getColor(this,R.color.transparnt))
        ...
        buttonAutom3amalat2anneemath.setOnClickListener {
            m_a.setText("2")
            m_f.setText("2")
            m_e.setText("2")
            m_i.setText("2")
...
if (checkBoxm3fatchkilia.isChecked){
    ...
    m_t.setText("1")
        ...
        buttonvide2anneemath.setOnClickListener {
            m_t_a.setText("")
            m_f_a.setText("")
            m_i_a.setText("")
            m_a.setText("")
    ...
    override fun onBackPressed() {
        ...
        alertt.buYes.setOnClickListener {
            val pref = getSharedPreferences("2anneemath", MODE_PRIVATE)
            val edit = pref.edit()
            ...
            edit.putString("ttm2anneemath",ttm2anneemath.text.toString())
            if (checkBoxm3fatchkilia.isChecked) {
        ...
        alertt.buNo.setOnClickListener {
            val V=""
            val dataput = getSharedPreferences("2anneemath", MODE_PRIVATE)
            ...
            edit.putString("ttm2anneemath",V)
            if (checkBoxm3fatchkilia.isChecked){
                edit.putBoolean("ischeckt",false)
            }else{
                edit.putBoolean("ischeckt",false)
    ...
    fun hsabntija2aneemath(view: View) {
        try {
            ...
            val amazighia: Float = (m_t_amz.text.toString().toFloat() + m_f_amz.text.toString()
                .toFloat() + (m_i_amz.text.toString().toFloat() * 2)) / 4
            val m3dlamazighia: Float = amazighia * m_amz.text.toString().toFloat()
            var ttm:Float=ttm2anneemath.text.toString().toFloat()
...
val m3amlatflmwad=m3dlarab + m3dlfrance + m3dlenglish + m3dlislamia + m3dltj + m3dlmath + m3dlalom + m3dlfizik + m3dlsport + m3dltrbiatchkilia + m3dlamazighia+ttm
                val intent = Intent(this, Resulet2aneemath::class.java)
