...
import kotlinx.android.synthetic.main.flsafabac.*
...
class flsafabac : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.flsafabac)
        ...
        buttonvideflsafa.setOnClickListener {
            ar.setText("")
            fr.setText("")
            en.setText("")
            `is`.setText("")
        ...
        bacflsafa.setOnClickListener {
            try {

                val alm3dl= (( (ar.text.toString().toFloat()*m_ar.text.toString().toFloat() )+(fr.text.toString().toFloat()*m_fr.text.toString().toFloat())+(en.text.toString().toFloat()*m_en.text.toString().toFloat())+(`is`.text.toString().toFloat()*m_is.text.toString().toFloat())+(tj.text.toString().toFloat()*m_tj.text.toString().toFloat())+(ma.text.toString().toFloat()*m_ma.text.toString().toFloat())+(fl.text.toString().toFloat()*m_fl.text.toString().toFloat())+(sp.text.toString().toFloat()*m_sp.text.toString().toFloat())+(amz.text.toString().toFloat()*m_amz.text.toString().toFloat()))/(m_ar.text.toString().toFloat()+m_fr.text.toString().toFloat()+m_en.text.toString().toFloat()+m_is.text.toString().toFloat()+m_tj.text.toString().toFloat()+m_ma.text.toString().toFloat()+m_fl.text.toString().toFloat()+m_sp.text.toString().toFloat()+m_amz.text.toString().toFloat())).toBigDecimal().setScale(2,
