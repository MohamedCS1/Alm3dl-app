...
import kotlinx.android.synthetic.main.resulet1eranneesentfic.*
...
class Resulet1anneesentfic : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.resulet1eranneesentfic)
        ...
        textviewttm1anneesentfic.text=ttm.toString()
        ...
        mlahda1anneesentfic.text="الملاحظة=$mlahda"
        textView14.text= ("المعدل---->$alm3dl---->$najh").toString()
        m3ml1annersentfic.text="مجموع المعاملات=$m3mlat"
        m3mlflmwad1aneesentfic.text="مجموع المعدلات مضروبة في معاملاتها=$m3amlatflmwad"
